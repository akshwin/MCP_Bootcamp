...
from storyforge_core import get_realtime_info as core_get_realtime_info
from storyforge_core import generate_video_transcription as core_generate_video_transcription

# Streamlit UI file: core logic lives in storyforge_core.py
...
def get_realtime_info(query):
    ...
    """
    try:
        return core_get_realtime_info(query)
...
def generate_video_transcription(info_text):
    try:
        return core_generate_video_transcription(info_text)
    except Exception as e:
