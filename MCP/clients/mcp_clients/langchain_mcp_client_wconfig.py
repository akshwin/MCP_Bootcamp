...
# ---------------------------
llm = ChatGroq(
    model="llama-3.1-8b-instant",             # Specify the Groq model to use (30k TPM limit, faster)
    temperature=0,                            # Set temperature to 0 for deterministic responses
    max_retries=2,                            # Set maximum retries for API calls to 2 in case of transient errors
    api_key=os.getenv("GROQ_API_KEY")  # Retrieve the Groq API key from environment variables
)
